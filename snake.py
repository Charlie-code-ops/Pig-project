...
import random #used to randomly place food in this case in a diff place each time
...
def move():
    ...
    snake.x += velocityX * TILE_SIZE #if here i didnt multiply by TILE_SIZE then it would move one pixel over rather than one tile
